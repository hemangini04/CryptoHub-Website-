...
<head>
    ...
    <title>Rail Fence Cipher Info</title>
...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">Rail Fence Cipher?</span></h1>
            <p>The Rail Fence Cipher is a transposition cipher that encrypts plaintext by writing it in a zigzag pattern across multiple rows and then reading it out row by row. It is a simple and easy-to-implement cipher that can be performed by hand without the need for complex calculations.</p>
            <p class="intro-para">In the Rail Fence Cipher:</p>
            <ul>
                <li><span class="bold">Encryption:</span> The plaintext is written diagonally in a zigzag pattern across multiple rows of an imaginary fence, and then the ciphertext is formed by reading the characters row by row.</li>
                <li><span class="bold">Decryption:</span> The ciphertext is written diagonally in the same zigzag pattern across the rows, and then the plaintext is obtained by reading the characters row by row.</li>
            </ul>
            <p>The Rail Fence Cipher is a type of transposition cipher, where the order of the characters in the plaintext is rearranged according to a predetermined system. While it is simple and easy to understand, it is not very secure and can be easily broken with modern cryptographic techniques.</p>
            <p class="example"><b>Example:</b></p>
            <p class="examples">Let's encrypt the numeric message "123456789" using the Rail Fence Cipher with 3 rails.</p>
            <p>1. Numeric Message: "123456789"</p>
            <p>2. Encryption with 3 Rails:</p>
            <pre>
                1     5     9
                 2   4 6   8
                  3     7
            </pre>
            <p>3. Ciphertext: "159246837"</p>
            <div class="try">
                <a href="railfence_cipher.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
