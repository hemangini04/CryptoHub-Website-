...
<head>
    ...
    <style>
        ...
        .dark_theme {
            ...
            --secondary-color: #fff;
            --hover-color: #00B0A5;
            --container-box-shadow-color: 0 0 10px rgba(255, 255, 255, 0.2);
...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">SHA-1 Hash Function???</span></h1>
            <p>SHA-1 (Secure Hash Algorithm 1) is a cryptographic hash function that produces a 160-bit (20-byte) hash
                value known as a message digest.</p>
            <p class="intro-para">SHA-1 is designed to be secure and reliable for various cryptographic applications,
                including digital signatures and data integrity verification.</p>
            <p>SHA-1 operates on input data and produces a fixed-size output, regardless of the size of the input.</p>
            <p>It applies a series of logical functions and bitwise operations to the input data, resulting in a unique
                hash value.</p>
            <p class="example"><b>Example: Generating SHA-1 Hash</b></p>
            <p class="examples">Let's generate the SHA-1 hash for the input string "Hello, World!".
                <br>The SHA-1 hash function will produce a unique 160-bit hash value.
            </p>
            <p>The resulting hash value is used to verify the integrity of the input data.</p>

            <p class="theory">SHA-1 is widely used for generating checksums, digital signatures, and data verification
                in various applications.</p>
            <p class="theory1">It provides a high level of security and reliability, although newer hash functions such
                as SHA-256 are recommended for stronger security.</p><br>
            <div class="try">
                <a href="SHA1_hash.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
