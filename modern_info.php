...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">Modern<span class="intro-span"><br>Algorithm</span></h1>
            <p class="intro-para">Modern cryptographic algorithms are sophisticated methods used to secure digital data and communications. They involve complex mathematical operations that transform plaintext into ciphertext (encryption) and back again (decryption) using keys.

                Symmetric algorithms like AES use the same key for both encryption and decryption, making them fast and efficient for large amounts of data. Asymmetric algorithms like RSA use a pair of keys, one public and one private, for encryption and decryption, respectively.

                These algorithms are crucial for ensuring the confidentiality, integrity, and authenticity of sensitive information in digital systems. They are used in various applications, including secure communication channels, digital signatures, and data protection mechanisms.

                Overall, modern cryptographic algorithms are essential tools for maintaining privacy and security in the digital age.</p><br>
            <p class="example"><b>Modern Algorithms list :<b></p>
            <ul>
                <li>
                    <h3><a href="Symmetric_info.php">Symmetric key</a></h3>
                </li>
                <li>
                    <h3><a href="Asymmetric_info.php">Asymmetric key</a></h3>
                </li>
            </ul>
        </div>
    </div>
