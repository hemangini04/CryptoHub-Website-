...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">Classical<span class="intro-span"><br>Algorithm</span></h1>
            <p class="intro-para">Classical cryptographic algorithms are fundamental methods for securing communication and data. Encryption involves transforming plaintext
                into ciphertext, making it unreadable without the correct decryption key. This process typically involves mathematical operations based on
                keys and algorithms.<br><br>

                Decryption is the reverse process, converting ciphertext back into plaintext using the decryption key. Symmetric algorithms, like the
                Caesar Cipher, use the same key for both encryption and decryption, while asymmetric algorithms, like RSA, use different keys for each
                operation.<br><br>

                Classical algorithms often rely on substitution (replacing plaintext elements with ciphertext elements) and transposition (rearranging
                elements) techniques. These algorithms have been foundational in the development of modern cryptography, providing the basis for secure
                communication over insecure channels and data protection in various systems.</p><br>
            <p class="example"><b>Classical Algorithms list :<b></p>
            <ul>
                <li>
                    <h3><a href="caesar_info.php">Caesar Cipher</a></h3>
                </li>
                <li>
                    <h3><a href="columnar_transsposition_info.php">Columnar Transpoition Cipher</a></h3>
                </li>
                <li>
                    <h3><a href="playfair_info.php">Playfair Cipher</a></h3>
                </li>
                <li>
                    <h3><a href="railfence_info.php">Railfence Cipher</a></h3>
                </li>
            </ul>
        </div>
    </div>
