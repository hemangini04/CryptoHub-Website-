...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">AES Symmetric Algorithm???</span></h1>
            <p>In cryptography, AES (Advanced Encryption Standard) is a symmetric encryption algorithm.</p>
            <p class="intro-para">AES is widely used to secure sensitive data. It was established as the standard by the
                U.S. National Institute of Standards and Technology (NIST) in 2001.</p>
            <p>AES operates on blocks of data of size 128 bits and uses key sizes of 128, 192, or 256 bits. The
                algorithm consists of multiple rounds of substitution and permutation.</p>
            <p>It's known for its efficiency and security, making it one of the most widely used encryption algorithms.
            </p>
            <p class="example"><b>Example 1: Encryption using AES Algorithm</b></p>
            <p class="examples">Let's encrypt the plaintext "HELLO" using the AES Algorithm with the key "SECRETKEY123".
                <br>1. Plaintext: HELLO <br>2. Key: SECRETKEY123<br>The encryption process involves multiple rounds of
                substitution and permutation:
            </p>
            <br>
            <ol>
                <li>Apply initial round key addition.</li>
                <li>Perform multiple rounds of substitution and permutation using round keys derived from the main key.
                </li>
                <li>Apply final round key addition.</li>
            </ol>
            <p>The resulting ciphertext is the encrypted message.</p>

            <p class="theory">AES is a symmetric encryption algorithm, meaning the same key is used for both encryption
                and decryption.</p>
            <p class="theory1">It's highly secure and efficient, suitable for securing sensitive information in various
                applications.</p>
            <p><b>Example 2: Decryption using AES Algorithm</b></p><br><br>
            <p>Let's decrypt the ciphertext: 1A3F54B7E9C3 using the AES Algorithm with the same key: "SECRETKEY123".</p>
            <p>The decryption process involves applying the reverse operations of encryption:</p>
            <ol>
                <li>Apply final round key addition (reversed).</li>
                <li>Perform multiple rounds of reverse substitution and permutation using round keys derived from the
                    main key (in reverse order).</li>
                <li>Apply initial round key addition (reversed).</li>
            </ol>
            <p>The resulting plaintext is the decrypted message.</p>
            <div class="try">
                <a href="AES_cipher.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
