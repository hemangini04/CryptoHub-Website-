...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">Hash<span class="intro-span"><br>Algorithm</span></h1>
            <p class="intro-para">Hash functions are cryptographic tools that take an input (or message) and produce a fixed-size string of bytes, typically a hash value or digest. This output is unique to the input, meaning even a small change in the input should result in a significantly different hash value. Hash functions are used for various purposes, including data integrity verification, digital signatures, and password hashing.

                Key properties of hash functions include collision resistance, where it should be computationally infeasible to find two different inputs that produce the same hash value. Preimage resistance ensures that given a hash value, it is computationally infeasible to find the original input. Hash functions are also designed to be deterministic, meaning the same input always produces the same output.

                Popular hash functions include the Secure Hash Algorithm (SHA) family, such as SHA-1 and SHA-256. SHA-256 is widely used for its security and efficiency. Hash functions play a crucial role in modern cryptography, ensuring the integrity and authenticity of data in digital systems.</p><br>
            <p class="example"><b>Hash Algorithms list :<b></p>
            <ul>
                <li>
                    <h3><a href="SHA1_info.php">SHA 1</a></h3>
                </li>
                <li>
                    <h3><a href="SHA256_info.php">SHA 256</a></h3>
                </li>
            </ul>
        </div>
    </div>
