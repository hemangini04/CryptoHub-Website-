...
<body>
    ...
    <nav>
        ...
        <script>
            // Constant 16-byte key for AES encryption and decryption
            ...
            document.getElementById("encryptionForm").addEventListener("submit", function(event) {
                ...
                var encryptedText = aesEncrypt(plaintext);
                document.getElementById("encryptedText").innerHTML = "Encrypted text:<br>" + encryptedText + "<br><br>Key:<br>" + keyToHex(key);
            });
            ...
            document.getElementById("decryptionForm").addEventListener("submit", function(event) {
                ...
                var decryptedText = aesDecrypt(ciphertext);
                document.getElementById("decryptedText").innerHTML = "Decrypted text:<br>" + decryptedText + "<br><br>Key:<br>" + keyToHex(key);
            });
        </script>
