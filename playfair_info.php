...
<head>
    ...
    <title>Playfair Cipher Info</title>
...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">Playfair Cipher?</span></h1>
            <p>The Playfair Cipher is a digraph substitution cipher that encrypts pairs of letters (digraphs) in plaintext to produce ciphertext. It employs a 5x5 grid of letters arranged in a key square to perform the encryption and decryption operations.</p>
            <p class="intro-para">In the Playfair Cipher:</p>
            <ul>
                <li><span class="bold">Key Square:</span> The key square is a 5x5 grid of letters (excluding 'J' to make 25 letters) arranged in a specific order. It is used to map plaintext letters to ciphertext digraphs and vice versa.</li>
                <li><span class="bold">Encryption:</span> Each pair of letters in the plaintext is mapped to a digraph based on their positions in the key square. If the letters are in the same row, they are replaced with the letters to their right (cycling back to the beginning if necessary). If the letters are in the same column, they are replaced with the letters below them (cycling back to the top if necessary). Otherwise, they are replaced with the letters in the same row but at the column of the other letter.</li>
                <li><span class="bold">Decryption:</span> Decryption in the Playfair Cipher involves reversing the process of encryption by mapping ciphertext digraphs back to plaintext letters based on their positions in the key square.</li>
            </ul>
            <p>The Playfair Cipher provides a higher level of security compared to simple substitution ciphers as it encrypts digraphs rather than individual letters. However, it is vulnerable to frequency analysis and can be broken with sufficient ciphertext.</p>
            <p class="example"><b>Example:</b></p>
            <p class="examples">Let's encrypt the numeric message "123456789" using the Playfair Cipher with the key "CIPHER".</p>
            <p>1. Numeric Message: "123456789"</p>
            <p>2. Key: "CIPHER"</p>
            <p>3. Encryption with Playfair Cipher:</p>
            <pre>
                1       2       3       4       5
                 6       7       8       9       X
            </pre>
            <p>4. Ciphertext: "163782594X"</p>
            <div class="try">
                <a href="playfair_cipher.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
