...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">SHA-256 Algorithm???</span></h1>
            <p>In cryptography, SHA-256 is a cryptographic hash function that produces a 256-bit (32-byte) hash value
                known as a message digest, typically rendered as a hexadecimal number. It is widely used in various
                security applications and protocols to generate unique fixed-size representations of input data.</p>
            <p class="intro-para">SHA-256 belongs to the SHA-2 family of hash functions, which also includes SHA-224,
                SHA-256, SHA-384, SHA-512, SHA-512/224, and SHA-512/256. It operates on 512-bit blocks and uses a
                Merkle-Damgård construction to process input data in sequential blocks.</p>
            <p>SHA-256 is considered to be secure against collision attacks and pre-image attacks when used
                appropriately with strong input data and key management practices.</p>
            <p class="example"><b>Example 1: Generating SHA-256 Hash</b></p>
            <p class="examples">Let's generate the SHA-256 hash of the message "Hello, World!"</p>
            <p>1. Message: "Hello, World!"</p>
            <p>The SHA-256 hash value is computed as follows:</p>
            <p>'Hello, World!' ⟶ SHA-256 Hash</p>
            <p>The resulting SHA-256 hash value is unique to the input message.</p>
            <p class="example"><b>Example 2: Verifying Data Integrity</b></p>
            <p class="examples">Let's verify the integrity of a file by comparing its SHA-256 hash value with the
                original hash value.</p>
            <p>1. Original SHA-256 Hash: [Original Hash Value]</p>
            <p>2. Current SHA-256 Hash: [Current Hash Value]</p>
            <p>If the current SHA-256 hash value matches the original hash value, the data integrity is preserved.</p><br>
            <div class="try">
                <a href="SHA256_cipher.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
