...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">caesar cipher???</span></h1>
            <p>In cryptography, a Caesar cipher, also known as the <span class="bold">shift cipher</span></p>
            <p class="intro-para">The Caesar Cipher is one of the simplest and oldest forms of encryption, named after
                Julius Caesar, who is believed to have used it to communicate with his generals. It's a type of
                substitution cipher where each letter in the plaintext is shifted a certain number of places down or up
                the alphabet.</p>
            <p class="example"><b>For example, with a shift of 3:<b></p>
            <p class="examples">'A' would be encrypted as 'D'.
                'B' would be encrypted as 'E'.
                'C' would be encrypted as 'F'.
                and so on.
            </p>
            <p class="theory">The Caesar Cipher is a form of symmetric encryption, meaning the same key is used for both
            ...
            <p class="theory1">It's straightforward to understand and implement, making it an excellent introduction to
                the concept of encryption. However, due to its simplicity, the Caesar Cipher is easily broken with
                modern cryptographic analysis techniques.</p>
            <p><b>Sure, now let's encrypt the message "HELLO" using the Caesar Cipher with a shift of 3.<b></p><br><br>
            <p>1. *Plaintext*: HELLO
                2. *Shift*: 3
            </p>
            <p>To encrypt each letter, we'll shift it three positions down the alphabet.</p>
            <p>'H' becomes 'K'</p>
            <p>'E' becomes 'H'</p>
            <p>'L' becomes 'O'</p>
            <p>'L' becomes 'O'</p>
            <p>'O' becomes 'R'</p>
            <p>So, the encrypted message "HELLO" becomes "KHOOR".</p>
            <div class="try">
                <a href="caesar_cipher.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
