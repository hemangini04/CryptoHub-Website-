...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">Symmetric Key<span class="intro-span"><br>Algorithm</span></h1>
            <p class="intro-para">Symmetric key cryptography involves using the same key for both encryption and decryption of data.This method is efficient and fast, making it suitable for securing large volumes of data. However, the challenge lies in securely exchanging the key between parties without interception. Popular algorithms like AES (Advanced Encryption Standard) and DES (Data Encryption Standard) are widely used in symmetric key cryptography. Despite its efficiency, symmetric key cryptography lacks the flexibility for secure communication over untrusted channels compared to asymmetric cryptography.</p><br>
            <p class="example"><b>Symmetric Key Algorithms list :<b></p>
            <ul>
                <li>
                    <h3><a href="AES_info.php">AES</a></h3>
                </li>
                <li>
                    <h3><a href="DES_info.php">DES</a></h3>
                </li>
