...
<body>
    ...
    <nav>
        ...
        <script>
            // Constant 8-character key for DES encryption and decryption
            var key = "pass297856362";

            // Function to perform DES encryption
            function desEncrypt(plaintext) {
                var encrypted = CryptoJS.DES.encrypt(plaintext, key).toString();
                return encrypted;
            }

            // Function to perform DES decryption
            function desDecrypt(ciphertext) {
                var decrypted = CryptoJS.DES.decrypt(ciphertext, key).toString(CryptoJS.enc.Utf8);
                return decrypted;
            }
            ...
            document.getElementById("encryptionForm").addEventListener("submit", function(event) {
                ...
                var encryptedText = desEncrypt(plaintext);
                document.getElementById("encryptedText").innerHTML = "Encrypted text:<br>" + encryptedText + "<br><br>Key:<br>" + key;
            });
            ...
            document.getElementById("decryptionForm").addEventListener("submit", function(event) {
                ...
                var decryptedText = desDecrypt(ciphertext);
                document.getElementById("decryptedText").innerHTML = "Decrypted text:<br>" + decryptedText + "<br><br>Key:<br>" + key;
            });
        </script>
        <script>
