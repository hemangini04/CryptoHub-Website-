...
<body>
    ...
    <nav>
        ...
        <div class="container">
            ...
            <div id="encryptedText" class="encrypted-container"></div>
            ...
            <div id="decryptedText" class="encrypted-container"></div>
        </div>
        ...
        <script>
            ...
            // Function to convert key to hexadecimal string
            ...
            document.getElementById("encryptionForm").addEventListener("submit", function(event) {
                ...
                var encryptedText = rsaEncrypt(plaintext);
                document.getElementById("encryptedText").innerHTML = "<div class='encrypted-container'>Encrypted text:<br>" + encryptedText + "<br><br>Public Key:<br>" + publicKey + "</div>";
            });
            ...
            document.getElementById("decryptionForm").addEventListener("submit", function(event) {
                ...
                var decryptedText = rsaDecrypt(ciphertext);
                document.getElementById("decryptedText").innerHTML = "<div class='encrypted-container'>Decrypted text:<br>" + decryptedText + "<br><br>Private Key:<br>" + privateKey + "</div>";
            });
        </script>
    </div>
    <script>
