    ...
    <nav>
        ...
        <div class="container">
            ...
            <form id="encryptionForm">
                <label for="plainTextInput">Enter text:</label><br>
        ...
        <script>
            document.getElementById("encryptionForm").addEventListener("submit", function(event) {
                ...
                const encryptedText = sha1(plainText);
                document.getElementById("encryptedOutput").textContent = "SHA-1 Hash: " + encryptedText;
            });
            ...
            function sha1(msg) {
                ...
                const final_hash = (cvt_hex(H0) + cvt_hex(H1) + cvt_hex(H2) + cvt_hex(H3) + cvt_hex(H4)).toLowerCase();
                return final_hash;
            }
        </script>
    </div>
