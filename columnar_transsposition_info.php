...
<head>
    ...
    <link rel="stylesheet" href="caesar_info.css">
...
<body>
    ...
    <nav>
        ...
        <div class="caesar-container">
            <h1 class="intro">What is <span class="intro-span">Columnar Transposition cipher???</span></h1>
            <p>In cryptography, a Columnar Transposition cipher, also known as the <span class="bold">Transposition cipher</span></p>
            <p class="intro-para">In cryptography, a Columnar Transposition Cipher is a type of transposition cipher where the plaintext is written out in rows and then read out again column by column. The columns are chosen according to the key provided. Each column's order can be rearranged based on the key, and then the columns are read out again to create the ciphertext.</p>
            <p class="example"><b>For example, with Plaintext: "HELLO"
                    Key: "3142"<b></p>
            <p class="examples">1.Arrange the plaintext into rows according to the length of the key.<br>
                H E L L O <br>
                2.Write out the columns according to the key's order.<br>
                Column 1: 1 2 3 4<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;H E L L<br>
                Column 2: 1 2 3<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O<br>
            ...
            <p class="theory">Columnar Transposition involves writing the plaintext out in rows, and then reading the ciphertext off in columns. In its simplest form, it is the Route Cipher where the route is to read down each column in order. For example, the plaintext "a simple transposition" with 5 columns looks like the grid below</p>
            <br><br><img src="image/columnar_transpos_example_1.png" style="margin-left:45%; mix-blend-mode:difference;"><br><br>If we now read down each column we get the ciphertext 'ALNISESTITPIMROOPASN'.
            <p class="theory1">It's straightforward to understand and implement, making it an excellent introduction to
                the concept of encryption. However, due to its simplicity, the columnar-transposition cipher is easily broken with
                modern cryptographic analysis techniques.</p>
            <p><b>Sure, now let's encrypt the message "The tomato is a plant in the nightshade family" using the keyword tomato. We get the grid given below.<b></p><br><br>
            <img src="image/columnar_transpos_example_2.png" style="margin-left:45%;mix-blend-mode:difference;"><br>The plaintext is written in a grid beneath the keyword. The numbers represent the alphabetical order of the keyword, and so the order in which the columns will be read.<br>
            <p> the first "O" is 3 and the second "O" is 4, and the same thing for the two "T"s.</p>
            <p>Starting with the column headed by "A", our ciphertext begins "TINESAX" from this column. We now move to the column headed by "M",, and so on through the letters of the keyword in alphabetical order to get the ciphertext "TINESAX / EOAHTFX / HTLTHEY / MAIIAIX / TAPNGDL / OSTNHMX" (where the / tells you where a new column starts). The final ciphertext is thus "TINES AXEOA HTFXH TLTHE YMAII AIXTA PNGDL OSTNH MX".</p>
            <p>So, the encrypted message "The tomato is a plant in the nightshade family" becomes ""TINES AXEOA HTFXH TLTHE YMAII AIXTA PNGDL OSTNH MX".".</p>
            <br>
            <div class="try">
                <a href="columnar_transposition.php"><button>Try for yourself</button></a>
            </div>
        </div>
    </div>
    <script>
